...
Search makeup products by brand, price, product category, tags, and more.

Learn more about Makeup API at [makeup-api.herokuapp.com](http://makeup-api.herokuapp.com).
...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/makeup` | publish pending — [install from git tag](https://github.com/voxgig-sdk/makeup-sdk/releases) |
...
| --- | --- | --- |
| **Product** | The Product entity (list). | `/products.json` |

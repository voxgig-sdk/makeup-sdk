...
class MakeupStreamingFeature extends MakeupBaseFeature
{
    ...
    private function _iterate(MakeupResult $result): \Generator
    {
    ...
    private function _streamable(MakeupContext $ctx): bool
    {

...
// Makeup SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class MakeupTestFeature extends MakeupBaseFeature
{
    ...
    public function init(MakeupContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (MakeupContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (MakeupContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(MakeupContext $ctx, $op, $args): array
    {

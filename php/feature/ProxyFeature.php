...
class MakeupProxyFeature extends MakeupBaseFeature
{
    ...
    public function init(MakeupContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (MakeupContext $ctx2, string $url2, array $fetchdef) use ($inner): array {

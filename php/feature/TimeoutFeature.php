...
class MakeupTimeoutFeature extends MakeupBaseFeature
{
    ...
    private function _with_timeout(MakeupContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(MakeupContext $_ctx, float $ms): void
    {
        $client = $this->client;

...
class MakeupRbacFeature extends MakeupBaseFeature
{
    ...
    private function _required(MakeupContext $ctx): ?string
    {
    ...
    private function _reject(MakeupContext $ctx, string $required): void
    {
    ...
    private function _track(MakeupContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;

...
class MakeupCacheFeature extends MakeupBaseFeature
{
    ...
    private function _through(MakeupContext $ctx, string $url, array $fetchdef, callable $inner): array
    {

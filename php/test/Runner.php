...
class MakeupTestRunner
{
    ...
    {
        $live = self::getenv('MAKEUP_TEST_LIVE');
        $override = self::getenv('MAKEUP_TEST_OVERRIDE');
        ...
        $explain = self::getenv('MAKEUP_TEST_EXPLAIN');
...
class_alias('MakeupTestRunner', 'Runner');
class_alias('MakeupHelpers', 'Helpers');

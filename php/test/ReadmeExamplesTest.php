...
// Makeup SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (MakeupSDK::test)
...
{
    private const SDK_CLASS = 'MakeupSDK';
    ...
    private const SDK_BASE = 'makeup_sdk';

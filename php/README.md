...
The PHP SDK for the Makeup API — an entity-oriented client using PHP conventions.
...
try {
    ...
    foreach ($products as $item) {
        echo $item["id"] . " " . $item["api_featured_image"] . "\n";
    }
} catch (\Throwable $err) {
...
The main class (`makeup_sdk.php`) exports the SDK class

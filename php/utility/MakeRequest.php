...
// Makeup SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class MakeupMakeRequest
{
    public static function call(MakeupContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new MakeupResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new MakeupResponse($fetched);
        } else {

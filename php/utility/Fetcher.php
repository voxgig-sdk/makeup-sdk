...
class MakeupFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; MakeupSDK/1.0)';
    ...
    public static function call(MakeupContext $ctx, string $fullurl, array $fetchdef): array
    {

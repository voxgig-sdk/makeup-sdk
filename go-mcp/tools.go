...
func registerTools(server *mcp.Server, client *sdk.MakeupSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "makeup_list",
		Description: "List records from Makeup. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "makeup_load",
		Description: "Load a single record from Makeup. " +
...
func runOp(client *sdk.MakeupSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.MakeupSDK, name string) (sdk.MakeupEntity, error) {

...
module MakeupTestRunner
  ...
  def self.env_override(m)
    live = getenv("MAKEUP_TEST_LIVE")
    override = getenv("MAKEUP_TEST_OVERRIDE")
    ...
    explain = getenv("MAKEUP_TEST_EXPLAIN")
    m["MAKEUP_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = MakeupTestRunner
Helpers = MakeupHelpers
Vs = VoxgigStruct

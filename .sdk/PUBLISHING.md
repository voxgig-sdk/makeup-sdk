...
|---|---|---|
| `ts/` | @voxgig-sdk/makeup-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/makeup-sdk \
      --repository voxgig-sdk/makeup-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/makeup-sdk` shows it, and
`npm trust revoke @voxgig-sdk/makeup-sdk --id=<id>` removes it.

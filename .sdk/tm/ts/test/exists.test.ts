...
describe('exists', async () => {
  ...
  //
  // MakeupSDK.test() is synchronous — it returns the client, not a promise
  ...
  test('test-mode', () => {
    ...
    equal(testsdk instanceof MakeupSDK, true,
      'MakeupSDK.test() must return a client synchronously')
  })

...
class MakeupRatelimitFeature extends MakeupBaseFeature
{
    ...
    private function _acquire(MakeupContext $ctx): void
    {
    ...
    private function _track(MakeupContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;

...
// Makeup SDK clienttrack feature
...
class MakeupClienttrackFeature extends MakeupBaseFeature
{
    ...
    public function PostConstruct(MakeupContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Makeup-SDK';

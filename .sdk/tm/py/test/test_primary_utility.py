...
from projectname_sdk import MakeupSDK
from projectname_sdk.core.spec import MakeupSpec
from projectname_sdk.core.result import MakeupResult
from projectname_sdk.core.response import MakeupResponse
from projectname_sdk.core.operation import MakeupOperation
from projectname_sdk.core.error import MakeupError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import MakeupBaseFeature
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = MakeupSDK.test(None, None)
        ...
        class TestInitFeature(MakeupBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(MakeupBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = MakeupSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = MakeupSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = MakeupSDK.test(None, setup_opts)

...
from projectname_sdk.core.control import MakeupControl
...
class MakeupContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, MakeupResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return MakeupError(code, msg, self)

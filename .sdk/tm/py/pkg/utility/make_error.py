...
def make_error_util(ctx, err):
    if ctx is None:
        from projectname_sdk.core.context import MakeupContext
        ctx = MakeupContext({}, None)

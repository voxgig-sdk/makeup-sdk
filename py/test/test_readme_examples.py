# Makeup SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions MakeupSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both MakeupSDK(...) and MakeupSDK.test(...) become
#      MakeupSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "makeup_sdk"
_SDK_CLASS = "MakeupSDK"

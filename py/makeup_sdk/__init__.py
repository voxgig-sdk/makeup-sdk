...
from makeup_sdk.utility import register

# Load features
from makeup_sdk.feature.base_feature import MakeupBaseFeature
from makeup_sdk.features import _has_feature, _make_feature
...
class MakeupSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = MakeupUtility()
        self._utility = utility

        from makeup_sdk.config import shared_config
    ...
    def get_utility(self):
        return MakeupUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("MakeupSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Product(self, data=None) -> "ProductEntity":
        ...
        from makeup_sdk.entity.product_entity import ProductEntity
        return ProductEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "MakeupSDK":
        if sdkopts is None:
            sdkopts = {}

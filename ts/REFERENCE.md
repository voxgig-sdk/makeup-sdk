# Makeup TypeScript SDK Reference

Complete API reference for the Makeup TypeScript SDK.
...
#### `MakeupSDK.test(testopts?, sdkopts?)`
...
**Returns:** `MakeupSDK` instance in test mode.
...
Return the parent `MakeupSDK` instance.

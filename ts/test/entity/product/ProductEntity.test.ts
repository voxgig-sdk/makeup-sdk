...
import { MakeupSDK, BaseFeature, stdutil } from '../../..'
...
describe('ProductEntity', async () => {
  ...
  afterEach(liveDelay('MAKEUP_TEST_LIVE'))

  test('instance', async () => {
    const testsdk = MakeupSDK.test()
...
function basicSetup(extra?: any) {
  ...
  let client = MakeupSDK.test(options, extra)

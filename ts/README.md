# Makeup TypeScript SDK



The TypeScript SDK for the Makeup API — a type-safe, entity-oriented client with full async/await support.
...
- Releases: [https://github.com/voxgig-sdk/makeup-sdk/releases](https://github.com/voxgig-sdk/makeup-sdk/releases)
...
| `tester(testopts?, sdkopts?)` | `MakeupSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `MakeupSDK.test(testopts?, sdkopts?)` | `MakeupSDK` | Create a test-mode client. |
...
| `client` | `client(): MakeupSDK` | Return the parent SDK client. |

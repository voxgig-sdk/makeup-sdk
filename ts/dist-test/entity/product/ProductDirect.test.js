...
function liveScenariosActive() { return false && process.env.MAKEUP_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.MakeupSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['MAKEUP_TEST_PRODUCT_ENTID'];
    ...
    const client = new __1.MakeupSDK({
        base: 'http://localhost:8080',

...
func registerSDKWords(r *eng.Registry, client *sdk.MakeupSDK) {
...
func runOp(client *sdk.MakeupSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {

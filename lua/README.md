...
The Lua SDK for the Makeup API — an entity-oriented client using Lua conventions.
...
GitHub release tag (`lua/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/makeup-sdk/releases)),
...
for _, item in ipairs(products) do
  print(item["id"], item["api_featured_image"])
end
```
...
The main module (`makeup_sdk`) exports the SDK constructor

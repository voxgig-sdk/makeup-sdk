# Makeup Lua SDK Reference

Complete API reference for the Makeup Lua SDK.
...
| `product_colors` | `table` | No | Available color variants of the product |
...
| `tag_list` | `table` | No | List of tags associated with the product (e.g., Vegan, Organic, Gluten Free) |
